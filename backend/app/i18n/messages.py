...
MESSAGES: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "choose_role": "Как вы хотите зарегистрироваться?",
        "btn_role_buyer": "🛒 Как обычный пользователь",
        "ask_phone": "Поделитесь номером телефона, чтобы завершить регистрацию.",
        "btn_share_phone": "📱 Поделиться номером",
        "onboarded_buyer": "✅ Готово! Теперь вы можете пользоваться маркетплейсом.",
    ...
    "uz": {
        ...
        "choose_role": "Qanday ro‘yxatdan o‘tmoqchisiz?",
        "btn_role_buyer": "🛒 Oddiy foydalanuvchi sifatida",
        "ask_phone": "Ro‘yxatdan o‘tishni yakunlash uchun telefon raqamingizni ulashing.",
        "btn_share_phone": "📱 Raqamni ulashish",
        "onboarded_buyer": "✅ Tayyor! Endi marketpleysdan foydalanishingiz mumkin.",
